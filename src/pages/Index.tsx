        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" className="h-9" onClick={() => navigate('/discover')}>
                <Search className="w-4 h-4 mr-1.5" />
                Discover
              </Button>
              <Button variant="outline" size="sm" className="h-9" onClick={() => navigate('/ranking')}>
          ...
          <div className="flex flex-wrap gap-2 py-3">
            {Object.entries(typeStats).map(([type, count]) => <div key={type} className="flex items-center gap-1 px-2 py-1 rounded-full bg-secondary/50 text-xs">
